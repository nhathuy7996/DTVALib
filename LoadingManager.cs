...
namespace DTVA.Lib
{
    ...
    {
        [SerializeField] doneCallbackType _onDoneCallbackType = doneCallbackType.Disable;
        [SerializeField]
        ...
        public LoadingManager Init(Action<List<bool>> onDone = null)
        {
            ...
            Debug.Log(CONSTANT.Prefix + $"==>Loading Start!<==");
            ...
            _loading.onValueChanged.AddListener((value) =>
            {
                if (value == 100)
                {
                    ...
                    _loading.onValueChanged.RemoveAllListeners();
                    if (_onDoneCallbackType == doneCallbackType.Destroy)
